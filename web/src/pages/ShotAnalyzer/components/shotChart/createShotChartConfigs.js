...
export function createShotChartConfigs({
  ...
  const mainDatasets = [
    ...
    {
      label: 'Adaptive Correction',
      data: model.series.adaptiveCorrection,
      borderColor: colors.adaptiveCorrection,
      backgroundColor: colors.adaptiveCorrection,
      borderDash: [5, 3],
      fill: false,
      yAxisID: 'yMain',
      pointRadius: 0,
      borderWidth: THIN_LINE_WIDTH,
      tension: 0.3,
      hidden: !model.series.adaptiveCorrection.length || !visibility.adaptiveCorrection,
    },
    {
