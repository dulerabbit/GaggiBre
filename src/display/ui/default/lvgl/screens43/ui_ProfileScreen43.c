...
// Elements placed directly on screen — no 182px offset panel.
#include "../ui.h"
...
void ui_ProfileScreen_screen_init_43(void) {
    ...
    // Menu (back) button — overhaul moves to TOP_MID
    ...
    lv_obj_set_size(ui_ProfileScreen_ImgButton1, 40, 40);
    ...
    ui_ProfileScreen_mainLabel = lv_label_create(ui_ProfileScreen);
    ...
    lv_obj_set_pos(ui_ProfileScreen_mainLabel, 0, 90);
    ...
    ui_ProfileScreen_profileName = lv_label_create(ui_ProfileScreen);
    ...
    lv_obj_set_pos(ui_ProfileScreen_profileName, 0, 140);
    ...
    // Previous profile button — angle-left icon, left side of screen
    ...
    lv_obj_set_size(ui_ProfileScreen_previousProfileBtn, 40, 40);
    lv_obj_set_align(ui_ProfileScreen_previousProfileBtn, LV_ALIGN_LEFT_MID);
    lv_obj_set_pos(ui_ProfileScreen_previousProfileBtn, 70, 0);
    ...
    // Next profile button — angle-right icon, right side of screen
    ...
    lv_obj_set_size(ui_ProfileScreen_nextProfileBtn, 40, 40);
    lv_obj_set_align(ui_ProfileScreen_nextProfileBtn, LV_ALIGN_RIGHT_MID);
    lv_obj_set_pos(ui_ProfileScreen_nextProfileBtn, -70, 0);
    ...
    // Loading spinner
    ui_ProfileScreen_loadingSpinner = lv_spinner_create(ui_ProfileScreen, 1000, 60);
    ...
    // ── Profile details overlay (full screen, hidden initially) ──────────────
    ui_ProfileScreen_profileDetails = lv_obj_create(ui_ProfileScreen);
    lv_obj_remove_style_all(ui_ProfileScreen_profileDetails);
    lv_obj_set_size(ui_ProfileScreen_profileDetails, 800, 480);
    ...
    // Prevent the full-screen overlay from intercepting touches on back/prev/next buttons
    lv_obj_clear_flag(ui_ProfileScreen_profileDetails, LV_OBJ_FLAG_CLICKABLE);
    ...
    lv_obj_set_size(ui_ProfileScreen_chooseButton, 40, 40);
    ...
    lv_obj_set_pos(ui_ProfileScreen_simpleContent, 0, 20);
    ...
    lv_obj_set_pos(ui_ProfileScreen_extendedContent, 0, 30);
    ...
    // Target info row — inside details overlay
    ...
    lv_label_set_text(ui_ProfileScreen_targetTemp2, "93\xC2\xB0" "C");
