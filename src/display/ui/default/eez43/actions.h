...
extern void action_on_manual_brew_load(lv_event_t * e);
extern void action_on_manual_brew_toggle(lv_event_t * e);
extern void action_on_manual_temp_press(lv_event_t * e);
extern void action_on_manual_temp_drag(lv_event_t * e);
extern void action_on_manual_temp_release(lv_event_t * e);
extern void action_on_manual_pressure_press(lv_event_t * e);
extern void action_on_manual_pressure_drag(lv_event_t * e);
extern void action_on_manual_pressure_release(lv_event_t * e);
extern void action_on_manual_pressure_snap_endpoint(lv_event_t * e);
extern void action_on_manual_flow_press(lv_event_t * e);
extern void action_on_manual_flow_drag(lv_event_t * e);
extern void action_on_manual_flow_release(lv_event_t * e);
extern void action_on_manual_brew_save(lv_event_t * e);
extern void action_on_manual_brew_discard(lv_event_t * e);
